      ...
      >
        ...
        {joinCode && (
          <View style={styles.section}>
            ...
            <View style={styles.card}>
              <View style={styles.cardRow}>
                <Text style={[styles.fieldValue, { fontFamily: 'monospace', fontSize: 22, letterSpacing: 4 }]}>{joinCode}</Text>
                <TouchableOpacity
                  style={[styles.iconBtn, { backgroundColor: 'rgba(99,102,241,0.2)', width: 'auto', paddingHorizontal: 12 }]}
              ...
              <View style={{ paddingHorizontal: 16, paddingBottom: 12 }}>
                <Text style={{ color: '#636366', fontSize: 12, lineHeight: 16 }}>
                  Share this code with your co-parent so they can join your family.
                </Text>
              </View>
            </View>
          </View>
